  ...
  return (
    <div>
      ...
      >
        <section ref={ref3}>
          ...
          >
            <p style={{ fontSize: "20px", marginBottom: "5%" }}>
              ...
              국가, 아랍 에미리트, 사우디 아라비아, 바레인, 카타르, 오만 등
              다양한 국가들에 수백만명의 숙련된 인력을 제공하며 글로벌 기업으로
              성장하였습니다.
              <br />
              <br />
              <br />
              조선, 자동차, 반도체, 건설, 의료, 서비스등 다양한 산업에 필요로
              하는 우수한 인재들을 추천, 고객사의 성공적인 사업을 위하여 최상의
        ...
        <section ref={ref2} style={{ marginLeft: "5%", marginTop: "5%" }}>
          <Row>
            <Col span={12}>
              <div style={{ height: 500 }}>{isInView2 && <PieChart />}</div>
            </Col>
            <Col span={12}>
              <div style={{ height: 500 }}>{isInView2 && <PieChart2022 />}</div>
            </Col>
          </Row>
        </section>
